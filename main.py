...
def average_minutes_delayed(flight_info):
    ...
    average_minutes_delayed = [minutes_delayed[i] / flight_info[i] for i in range(len(minutes_delayed)) if flight_info[i] != 0]
    ...
    return average_minutes_delayed


def main():
    delays = delayed_flights()
    average_minutes_delayed(delays)
